...
function createClip () {
  ...
  if (apiClip.get('has_clip')[0]) {
  	clipPatch = this.patcher.newdefault(200, 200, 'bpatcher', 'clip.maxpat', '@args', parentPath + '/clip', '@presentation', 1, '@patching_rect', [295, 171, 125, 33], '@presentation_rect', [0, 0, 125, 33], '@varname', 'clip')	
