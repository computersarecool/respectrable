...
function fillInLabel (apiObject) {
  "use strict";
  var maxTrackColor;
...
function createMixerDevice (scriptingPath) {
  "use strict";
  var mixerDevicePatch;

  mixerDevicePatch = this.patcher.newdefault(200, 200, 'bpatcher', 'mixer_device.maxpat', '@args', '/' + scriptingPath + '/mixer_device', '@presentation', 1, '@border', 1, '@patching_rect', [496, 522, 129, 198], '@presentation_rect', [0, 187, 129, 198], '@varname', 'mixer_device');
...
function createClipSlotsContainer (scriptingPath) {
  "use strict";
  var clipSlotContainer;
  
  clipSlotContainer = this.patcher.newdefault(200, 200, 'bpatcher', 'clip_slots.maxpat', '@args', '/' + scriptingPath, '@presentation', 1, '@enablevscroll', 1, '@border', 1, '@patching_rect', [730, 522, 129, 173], '@presentation_rect', [0, 26, 120, 135], '@varname', 'clip_slot_list');
...
function createDevicelist (apiObject, scriptingPath) {
  ...
  if (numDevices >= 1) {
    devicesList = this.patcher.newdefault(200, 200, 'bpatcher', 'devices_list.maxpat', '@args', '/' + scriptingPath, '@presentation', 1, '@border', 1, '@patching_rect', [932, 522, 210 * numDevices, 173], '@presentation_rect', [0, 400, 110, 188], '@enablehscroll', true, '@varname', 'devices_list');
