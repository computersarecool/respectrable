...
function anything () {
  ...
  if (messagename === 'bang') {
    ...
    this.patcher.newdefault(200, 200, 'bpatcher', 'live_set.maxpat', '@args', '/live_set', '@presentation', 1, '@enablevscroll', 1, '@enablehscroll', 1, '@patching_rect', [33.5, 165, 1200, 591], '@presentation_rect', [0, 0, 613, 169], '@varname', 'live_set')
    outlet(0, 'bang')
  }
}
