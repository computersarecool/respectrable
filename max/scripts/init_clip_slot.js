...
function anything () {
  ...
  if (messagename === 'bang') {
    ...
    if (apiObject.get('has_clip')[0]) {
      this.patcher.newdefault(200, 200, 'bpatcher', 'live_clip.maxpat', '@args', path + '/clip', '@presentation', 1,
        '@patching_rect', [726, 224, 125, 33], '@presentation_rect', [0, 0, 144, 26], '@varname', 'clip')
    }
