...
function createDevicelist (apiObject, scriptingPath) {
  ...
  if (numDevices >= 1) {
    this.patcher.newdefault(200, 200, 'bpatcher', 'live_devices.maxpat', '@args', '/' + scriptingPath, '@presentation', 1, '@border', 1, '@patching_rect', [932, 522, 220 * numDevices, 188], '@presentation_rect', [0, 400, 129, 197], '@enablehscroll', true, '@varname', 'devices_container')
  }
}
